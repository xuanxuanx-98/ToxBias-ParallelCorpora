...
Usage:
    $ python checkPerspectiveAPICredibility.py
"""
...
def print_results(og_scores, aave_scores, nigerianD_scores, indianD_scores, singlish_scores):
    ...
    print("NigerianD:", len(nigeriand_tox), "(toxic) /", len(nigerianD_scores), "(total)")
    print("IndianD:  ", len(indind_tox), "(toxic) /", len(indianD_scores), "(total)")
    print("Singlish: ", len(singlish_tox), "(toxic) /", len(singlish_scores), "(total)\n")
...
if __name__ == "__main__": 
    ...
    print_results(og_scores, aave_scores, nigerianD_scores, indianD_scores, singlish_scores)
